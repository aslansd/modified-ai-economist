...
"""
Unit tests for the wood and stone and iron scenario + basic components
"""

import unittest
import numpy as np

from modified_ai_economist import foundation
...
class CreateEnv:
    ...
    def set_env_config(self):
        ...
        self.env_config = {
            ...
            # Similar to scenarios/simple_wood_and_stone_and_iron/dynamic_layout/Uniform    
