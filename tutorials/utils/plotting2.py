...
def breakdown(log, remap_key=None, environment_type=None, episode_length=2000):
    ...
    if trading_active:
        ...
        variables_matrix = np.zeros((episode_length, n, 6))
        ...
        if environment_type == "Band":
            fig0.savefig('Band/Visualizaion of the World_Band.png')
            fig1.savefig('Band/Budget of Resources_Band.png')
            fig2.savefig('Band/Movement of Agents_Band.png')
            fig3.savefig('Band/Trading of Agents_Band.png')

        if environment_type == "Uniform":
            fig0.savefig('Uniform/Visualizaion of the World_Uniform.png')
            fig1.savefig('Uniform/Budget of Resources_Uniform.png')
            fig2.savefig('Uniform/Movement of Agents_Uniform.png')
            fig3.savefig('Uniform/Trading of Agents_Uniform.png')
            
        return (fig0, fig1, fig2, fig3), incomes, endows, c_trades, all_builds, variables_matrix
