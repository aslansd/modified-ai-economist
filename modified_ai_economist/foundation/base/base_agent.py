...
class BaseAgent:
    ...
    def __init__(self, idx=None, multi_action_mode=None):
        ...
        # Special flag to allow logic for multi-action-mode agents that are not given any actions.
    ...
    def register_components(self, components):
        ...
        for component in components:
            ...
            # They can also internally handle multiple actions-per-agent, so n is an tuple or list
    ...
    def action_spaces(self):
        ...
        if self.multi_action_mode == True:
            ...
            Example:
                ...
                [4, 5, 7]
                >> self._action_names
                ["Build", "Gather", "VoteInvest"]
                # [3 Build actions + Build NO-OP, 4 Gather actions + Gather NO-OP, 6 VoteInvest actions + VoteInvest NO-OP]
        ...
        if self.multi_action_mode == False:
            ...
            Example:
                ...
                >> self._action_names
                ["Build", "Gather", "VoteInvest"]
                # 1 NO-OP + 3 Build actions + 4 Gather actions + 6 VoteInvest actions
        """
    ...
    def endogenous(self):
        ...
        Example:
            >> self.endogenous
            {"Labor": 30.25, "VoteInvest": [1.0, 2.0, 3.0]}
        """
    ...
    def inventory(self):
        ...
        Example:
            >> self.inventory
            {"Wood": 3, "Stone": 20, "Iron": 5, "Coin": 1002}
        """
...
Example:
    from modified_ai_economist.foundation.base.base_agent import BaseAgent, agent_registry
