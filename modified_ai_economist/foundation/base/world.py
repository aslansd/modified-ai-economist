...
from modified_ai_economist.foundation.agents.mobiles import BasicMobileAgent
from modified_ai_economist.foundation.agents.planners import BasicPlanner

BasicMobileAgent = BasicMobileAgent()
