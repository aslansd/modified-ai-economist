...
class sparse_aridisolatic_society(BaseEnvironment):
    """
    World containing sparse spatially-segregated stone and wood and iron with stochastic regeneration.
    ...
    name = "sparse_aridisolatic_society"
    ...
    def make_source_prob_maps(self):
        ...
        return {
            "Wood": prob_gradient[-1::-1, 1] * self.layout_specs["Wood"]["starting_coverage"],
            "Stone": prob_gradient[-1::-1, int(self.world_size[1] / 2)] * self.layout_specs["Stone"]["starting_coverage"],
            "Iron": prob_gradient[-1::-1, -2] * self.layout_specs["Iron"]["starting_coverage"],
        }
...
@scenario_registry.add
class dense_aridisolatic_society(BaseEnvironment):
    """
    World containing dense spatially-segregated stone and wood and iron with stochastic regeneration.
    ...
    name = "dense_aridisolatic_society"
    agent_subclasses = ["BasicMobileAgent", "BasicPlanner"]
    required_entities = ["Wood", "Stone", "Iron"]
