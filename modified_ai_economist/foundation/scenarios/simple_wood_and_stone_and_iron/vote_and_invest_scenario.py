...
class UniformVoteAndInvest(BaseEnvironment):
    ...
    def reset_agent_states(self):
        ...
        # Clear everything to start with inequality to test social mobility
        # for agent in self.world.agents:
        #     if int(agent.idx) == 0 or int(agent.idx) == 1:
        #         agent.state["inventory"]["Coin"] = 25.0
        #         agent.state["escrow"]["Coin"] = 0.0
        #         agent.state["inventory"]["Wood"] = 25
        #         agent.state["escrow"]["Wood"] = 0
        #         agent.state["inventory"]["Stone"] = 25
        #         agent.state["escrow"]["Stone"] = 0
        #         agent.state["inventory"]["Iron"] = 25
        #         agent.state["escrow"]["Iron"] = 0
        #         agent.state["endogenous"]["Labor"] = 0.0
        #         agent.state["endogenous"]["VoteInvest"] = 25.0 * np.random.random(3)
                
        #     elif int(agent.idx) == 2:
        #         agent.state["inventory"]["Coin"] = 50.0
        #         agent.state["escrow"]["Coin"] = 0.0
        #         agent.state["inventory"]["Wood"] = 50
        #         agent.state["escrow"]["Wood"] = 0
        #         agent.state["inventory"]["Stone"] = 50
        #         agent.state["escrow"]["Stone"] = 0
        #         agent.state["inventory"]["Iron"] = 50
        #         agent.state["escrow"]["Iron"] = 0
        #         agent.state["endogenous"]["Labor"] = 0.0
        #         agent.state["endogenous"]["VoteInvest"] = 50.0 * np.random.random(3)
                
        #     elif int(agent.idx) == 3 or int(agent.idx) == 4:
        #         agent.state["inventory"]["Coin"] = 75.0
        #         agent.state["escrow"]["Coin"] = 0.0
        #         agent.state["inventory"]["Wood"] = 75
        #         agent.state["escrow"]["Wood"] = 0
        #         agent.state["inventory"]["Stone"] = 75
        #         agent.state["escrow"]["Stone"] = 0
        #         agent.state["inventory"]["Iron"] = 75
        #         agent.state["escrow"]["Iron"] = 0
        #         agent.state["endogenous"]["Labor"] = 0.0
        #         agent.state["endogenous"]["VoteInvest"] = 75.0 * np.random.random(3)
