...
class OneStepEconomy(BaseEnvironment):
    ...
    As described in https://arxiv.org/abs/2108.02755:
        A simplified version of simple_wood_and_stone_and_iron scenario where both the planner
    ...
    Args:
        ...
        mixing_weight_maximin_vs_coin (float): Must be between 0 and 1 (inclusive).
            Controls the weighting of maximin and productivity when using SWF
            "coin_maximin_times_productivity", where a value of 0 (default) yields equal
            weighting, and 1 only considers productivity.
    """
    ...
    def __init__(
        ...
        *base_env_args,
        ...
        mixing_weight_maximin_vs_coin=0,
        **base_env_kwargs
    ):
        ...
        self.mixing_weight_maximin_vs_coin = mixing_weight_maximin_vs_coin
    ...
    def get_current_optimization_metrics(self, agents, isoelastic_eta=0.23, labor_exponent=2.0, labor_coefficient=0.1):
        """
