...
def get_maximin(endowments):
    """
    Returns the minimium endowment among agents indicating the second Rawlsian Principle of Justice (Maximin).
    ...
    Returns:
        The minimum endowment (float).
    """
    
    return np.min(endowments)