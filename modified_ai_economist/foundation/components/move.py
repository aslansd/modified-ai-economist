...
class Gather(BaseComponent):
    ...
    name = "Gather"
    required_entities = ["Coin", "RedHouse", "BlueHouse", "GreenHouse", "Labor"]
    ...
    def component_step(self):
        ...
        for agent in world.get_random_order_agents():
            ...
            if action not in [0, 1, 2, 3, 4]:
                action = 0
                agent.set_component_action(self.name, action)
            ...
            if action == 0:  # NO-OP!
                ...
                # Attempt to move the agent (if the new coordinates aren't accessible, nothing will happen)
